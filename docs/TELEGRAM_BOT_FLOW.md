...
In Stage 2, the Mini App can show streets assigned by the API. In Stage 3, the Mini App can show and update assigned households through the API. The bot still does not own permissions, household assignments, or database writes.
